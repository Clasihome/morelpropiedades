        ...
        (t[n].prototype = {
          ...
          openPanel: function(e, i) {
            if (
              ...
              e &&
                e.length &&
                (e.is("." + s.panel) || (e = e.closest("." + s.panel)),
                e.is("." + s.panel)))
            ) {
              var r = this;
          ...
          closePanel: function(t) {
            ...
            e.hasClass(s.vertical) &&
              (e.removeClass(s.opened), this.trigger("closePanel", t)),
          ...
          togglePanel: function(t) {
            var e = t.parent();
            e.hasClass(s.vertical) &&
              this[e.hasClass(s.opened) ? "closePanel" : "openPanel"](t);
          },
          ...
          _initAddons: function() {
            ...
            var e;
            for (e in t[n].addons)
              t[n].addons[e].add.call(this),
                (t[n].addons[e].add = function() {});
                ...
                e.filter(this.conf.panelNodetype).each(function() {
                  ...
                  if (e) {
                    ...
                    var r = e
                      ...
                      .add(e.children("." + i.conf.classNames.panel));
                    r.length && a.call(i, r);
                  }
                });
              };
          ...
          _initPanel: function(t) {
            ...
            t.removeAttr("id"),
              t.is("ul, ol") && (t.wrap("<div />"), (t = t.parent())),
          ...
          _initListview: function(e) {
            ...
            if (
              r &&
              r.parent().is("." + s.listview) &&
              !r.children("." + s.next).length
            ) {
              var o = r.children("a, span").first(),
                l = t(
                  '<a class="' + s.next + '" href="#' + e.attr("id") + '" />'
                ).insertBefore(o);
          ...
          _initAnchors: function() {
            ...
            o.$body.on(r.click + "-oncanvas", "a[href]", function(i) {
              ...
              if (
                ...
                e.__valueOrFn(e.opts.onClick.setSelected, a) &&
                ...
                f && i.preventDefault(),
                  e.__valueOrFn(e.opts.onClick.close, a, f) &&
                    e.opts.offCanvas &&
          ...
          _fireMatchMedia: function() {
            for (var t in this.mtch)
              for (
                var e =
                    window.matchMedia && window.matchMedia(t).matches
                      ? "yes"
                      : "no",
                  n = 0;
            ...
            var i = !1,
              s = function(n) {
                ("undefined" != typeof n && n.target != t[0]) ||
                  (i ||
                    (t.off(r.transitionend),
                    t.off(r.webkitTransitionEnd),
                    e.call(t[0])),
                  (i = !0));
              };
            t.on(r.transitionend, s),
              t.on(r.webkitTransitionEnd, s),
              setTimeout(s, 1.1 * n);
          },
      ...
      (t[e].addons[n] = {
        setup: function() {
          if (this.opts[n]) {
            ...
            (r = t[e].glbl),
              ...
              "string" != typeof o.pageSelector &&
                (o.pageSelector = "> " + o.pageNodetype),
              (this.vars.opened = !1);
            var l = [i.offcanvas];
            "left" != a.position && l.push(i.mm(a.position)),
              ...
              this.bind("initExtensions:after", function() {
                for (
                  var t = [i.mm("widescreen"), i.mm("iconbar")], e = 0;
                  e < t.length;
                  e++
                )
        ...
        (t[e].prototype["_initWindow_" + n] = function() {
          r.$wndw.off(a.keydown + "-" + n).on(a.keydown + "-" + n, function(t) {
            if (r.$html.hasClass(i.opened) && 9 == t.keyCode)
              return t.preventDefault(), !1;
          });
          var t = 0;
          r.$wndw
            .off(a.resize + "-" + n)
            .on(a.resize + "-" + n, function(e, n) {
            ...
            r.$blck
              ...
              .on(
                ...
                function(t) {
                  t.preventDefault(),
                    t.stopPropagation(),
                    r.$blck.trigger(a.mousedown + "-" + n);
                }
              )
              .off(a.mousedown + "-" + n)
              .on(a.mousedown + "-" + n, function(t) {
                t.preventDefault(),
                  r.$html.hasClass(i.modal) || (e.closeAllOthers(), e.close());
              }));
        });
      var i, s, a, r;
    })(jQuery)
          ...
          (r = t[e].glbl),
            ...
            o.text &&
              ...
              this.bind("initNavbar:after", function(n) {
                ...
                a && (r += " (" + a + ")"),
                  s.children("." + i.prev).html(this.__sr_text(r));
              }),
        ...
        d.add &&
          this.bind("initListview:after", function(e) {
            ...
            n.each(function() {
              ...
              e &&
                (e.children("em." + i.counter).length ||
            ...
            e.each(function() {
              ...
              if (n) {
                ...
                c.length &&
                  ...
                  e.length && c.html(s.__filterListItems(e.children()).length));
              }
            });
        };
